...
| Agent operability | 89 | block on harness failure | `verify` covers task branches; `ci` covers clean main/CI, execution-plan structure, request-intake planning meeting guidance, and tested worker-prefixed start/finish report templates. |
